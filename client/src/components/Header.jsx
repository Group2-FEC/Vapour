...
const Header = ({ wishlist }) => {
  return (
    <div className="bg-slate-700/70 border-b border-gray-600 pt-5 md:pt-10">
      <header>
        <div
          id="userBar"
          className="flex justify-end items-center px-5 gap-2 py-1 md:hidden"
        >
          <img
        ...
        >
          <div className="flex gap-2 text-white font-bold sm:gap-5 items-center">
            <Navbar wishlist={wishlist} />
          </div>
          <div
            id="userBar"
            className="hidden md:flex justify-end items-center px-5 gap-2 py-1"
          >
            <img
              className="w-10 bg-sky-200 p-2 rounded"
              src={announcement}
